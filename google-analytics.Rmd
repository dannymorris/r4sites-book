...
# Analyzing user traffic {#google-analytics}
...
6. [Sign up for Google Analytics](#create-accounts)
...
## Analyze traffic using R

[googleAnalyicsR](https://code.markedmondson.me/googleAnalyticsR/) is an R package that makes it easy to query your Google Analytics data.
