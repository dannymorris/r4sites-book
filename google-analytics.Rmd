...
3. Click on "All Web Site Data". [📷 Image](https://i.imgur.com/lyNPi8E.png)

4. In the dropdown menu, select the Account and Property you created during the initial [setup](#ga-setup), then select the "All Web Site Data" View. [📷 Image](https://i.imgur.com/xSjCS75.png)

5. Go to the Home page and locate the card titled "Active Users right now". If the integration was successful, this value should be a minimum of 1 since you are currently on your website. [📷 Image](https://i.imgur.com/KPbUB7G.png)
...
[googleAnalyicsR](https://code.markedmondson.me/googleAnalyticsR/) is an R package that makes it easy and fun to query your Google Analytics data. Before diving into the code, spend some time learning about Google Analytics Dimensions and Metrics.
