...
- [Tranquilpeak](https://themes.gohugo.io/hugo-tranquilpeak-theme/){target="blank"} - Modern, clean layout. Easy to customize and very readable. Great for personal websites, blogs, and portfolios.

- [Anatole](https://themes.gohugo.io/anatole/){target="blank"} - Similar to Tranquilpeak with a more sophisticated About page.
