# Choosing a Hugo theme {#choose-theme}
...
2. Once you find something you really like, click "Download" on the theme homepage to be taken to the source code in GitHub. [📷 Image](https://i.imgur.com/ld35gNP.png).
...
This chapter teaches you the basic steps to create, publish, and analyze your very own website. The following chapters explain this material in greater detail, helping you to understand some of the deeper technical aspects as well as the techniques for customizing your website. Continue on to the chapter [Generating a blogdown website](#generate) to get started.
