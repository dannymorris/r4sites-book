...
subtitle: "A digital handbook with step-by-step instructions for creating personal websites, blogs, and project portfolios using R, RStudio, and other freely available technologies including GitHub, Hugo, Netlify, and Google Analytics"
author: "Danny Morris"
date: "`r Sys.Date()`"
...
The target audience for this book includes current or aspiring R users, Data Analysts, and Data Scientists who are interested in establising or enriching their online presence with a personal website, blog, or project portfolio.

## Hugo, blogdown, and static websites

This book teaches you how to build static websites using [Hugo](https://gohugo.io/) and [blogdown](https://bookdown.org/yihui/blogdown/). Hugo is a modern, user-friendly website generator that turns front-end content (Markdown, HTML, CSS, Javascript) into fast, flexible, and attractive websites. Blogdown is an R package that leverages Hugo to generate websites from the aforementioned front-end content *and* R Markdown documents. The integration of Hugo and R Markdown, which supports R, Python, and SQL languages, means website developers can author content that features code along with its output including tables and interactive data visualizations. 
...
**Can I author content, such as blog posts, using programming languages other than R?**

Yes. Content can be created with either plain Markdown documents or R Markdown documents which include support for R, Python, and SQL.
