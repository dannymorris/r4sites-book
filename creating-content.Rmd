...
The following posts on the [Posts](https://r4sites-anatole-custom.netlify.app/post/) page intend to show you my approach to authoring posts using R Markdown and configuring the post to contain useful features including code highlighting and a table of contents.
...
The [Posts page](https://r4sites-anatole-custom.netlify.app/post/) is the designated home for your original content. This is where your users can find your blog posts, tutorials, research articles, project descriptions, or other original content. 
