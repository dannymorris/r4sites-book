...
The Hugo Anatole theme comes with default posts and default text on the About page. To delete or edit the default content, follow the steps below.

- To edit the About page, navigate to `content/english/about.md`. Replace the metadata (i.e. the parameters in between the `---` markers) then replace the body of the Markdown document.

- To delete all default posts, navigate to the `content/english/post` folder and delete all files and folders **except `_index.md`**.
