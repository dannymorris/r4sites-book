...
This chapter exposes you to the entire methodology for creating, publishing, and analyzing websites through a quick example. If you complete the steps described in this chapter, you will end up with this [basic website](https://r4sites-anatole.netlify.app/). Later chapters build upon this this basic website to create this [customized version](https://r4sites-anatole-custom.netlify.app/).
...
5. Update the `config/_default/params.toml` file in the main webiste folder to update the `contactFormAction` parameter with your form endpoint, as shown in this [example](https://github.com/dannymorris/r4sites-demo/blob/master/config/_default/params.toml#L18-L19).
